...
DATABASES = {
    'default': {
        ...
        'TEST_NAME' : 'carpooltestdb',   # Name of test db to be created
    }
}
...
SECRET_KEY = 'f-pepn1389lix!^5br(zp(#sr4hc0$qq*4#iux0f0k2q^8&amp;z=='
...
#needed for Heroku. Comment the line below to run locally.
